...
urlpatterns = [
    ...
    # =========================================================
    # B — STRUCTURE (DEGRÉS / NIVEAUX / GROUPES)
    # =========================================================
    # Degrés
    ...
    # Batch receipts (parents/fratrie)
    ...
    # Paiements parents
    path("paiements/parents/<slug:group_key>/", views.paiement_parent_detail, name="paiement_parent_detail"),

    # ✅ Remboursement PAR PAIEMENT (batch_token ou TX-<id>)
    path("paiements/<str:group_key>/rembourser/", views.transaction_remboursement_create, name="paiement_remboursement_create"),

    # ✅ (doublon que tu avais) — je le garde MAIS je corrige:
    # - pas de "core/" ici sinon tu fais /core/core/...
    # - name différent pour ne pas casser {% url %}
    path("paiements/<str:group_key>/rembourser/alt/", views.transaction_remboursement_create, name="paiement_remboursement_create_alt"),
    ...
    # =========================================================
    # L — FINANCE (NOUVELLE LOGIQUE TRANSACTIONS)
    # =========================================================
    ...
    path("finance/transactions/batch/<str:batch_token>/pdf/", views_finance.transaction_batch_pdf, name="transaction_batch_pdf"),

    # Success (⚠️ tu l'avais 2 fois, je garde les 2 MAIS names différents)
    path("finance/transactions/<int:tx_id>/success/", views_finance.transaction_success, name="transaction_success"),
    path("transactions/<int:tx_id>/success/", views_finance.transaction_success, name="transaction_success_alias"),
    ...
    path("ajax/parents/search/", views_finance.ajax_parents_search, name="ajax_parents_search"),
    path("ajax/enfants-by-parent/", views_finance.ajax_enfants_by_parent, name="ajax_enfants_by_parent"),
